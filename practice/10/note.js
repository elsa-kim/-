...
부모에서 자식 state 속성 변경 : 부모 컴포넌트에서 자식으로 어떤 데이터 전달할 때 속성(this.props) 사용, 부모 컴포넌트에서 자식으로 어떤 데이터 전달한 뒤 화면 내용 변경할 때도 속성(this.props) 사용
자식에서 부모 state 속성 변경 : 메소드 사용(부모 컴포넌트에서 자신(부모) 속성 변경하는 메소드 자식에게 전달 후 자식에서 이를 호출)
